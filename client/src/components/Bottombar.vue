      ...
      <div class="actions">
        ...
        <div class="mdc-menu-anchor">
          ...
          <div class="mdc-simple-menu mdc-simple-menu--open-from-bottom-right bottombar-menu" tabindex="-1">
            <ul class="mdc-simple-menu__items mdc-list" role="menu" aria-hidden="true">
              <li class="mdc-list-item" role="menuitem" tabindex="0" :aria-disabled="isAtEpisode" v-if="scene.episode" v-on:click="goToEpisode($event)">{{ $t('bottom_bar.go_to_episode', [scene.episode.name ? scene.episode.name : $t('episode.unnamed', [scene.episode.number])]) }}</li>
